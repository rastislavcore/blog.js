...
const { getCryptohubPost } = require('../src/index');
...
describe('getCryptohubPost function', () => {
  it('should be defined', () => {
    expect(getCryptohubPost).toBeDefined();
  });

  it('should return array', async () => {
    const result = await getCryptohubPost({
      user: 'rastislav',
    });
  ...
  it('should return empty array for empty user', async () => {
    const result = await getCryptohubPost({ user: '' });
